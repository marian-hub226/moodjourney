...
hero_section = f"""
<div style='padding:35px; border-radius:30px; background:linear-gradient(135deg,rgba(255,255,255,0.08),rgba(255,255,255,0.03)); border:1px solid rgba(255,255,255,0.12); box-shadow:0px 0px 50px {color};'>
...
canvas_title = f"""
<div style='padding:20px; border-radius:20px; background:rgba(255,255,255,0.05); border:1px solid rgba(255,255,255,0.08); box-shadow:0px 0px 40px {color}; text-align:center;'>

<h2 style='color:{color}; margin:0;'>

🖼 {t("Creative Canvas", "Lienzo Creativo")}
...
st.markdown(canvas_title, unsafe_allow_html=True)
